...
productDetails.innerHTML = productDetailsHtml;
    ...
    // if (product.product.numOfReviews >= 1) {
    ...
    //    </div>
    //   `;
    //   const productDetailDiv = document.querySelector('.col-lg-8');
    //   productDetailDiv.insertAdjacentHTML('beforeend', reviewSectionHtml);
    // }
