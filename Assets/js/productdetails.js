    ...
    const productDetailsHtml = `
      ...
      <div class="col-lg-8">
        <div>
          ...
          <button aria-label="btn" class="btn btn-outline-primary my-3 px-5 add-to-cart-button" id="add-to-cart-button"><i class="fa fa-shopping-cart me-1" aria-hidden="true"></i> Add to cart</button>
        </div>   
      </div>`;
